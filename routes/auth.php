...
// Twitter login
Route::get('login/twitter', [AuthenticatedSessionController::class, 'redirectToTwitter'])->name('login.twitter');
Route::get('login/twitter/callback', [AuthenticatedSessionController::class, 'handleTwitterCallback']);
